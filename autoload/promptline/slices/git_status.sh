function __promptline_git_status {
  ...
  let added_symbol = promptline#symbols#get().added_symbol
  let unmerged_symbol = promptline#symbols#get().unmerged_symbol
  let modified_symbol = promptline#symbols#get().modified_symbol
  let clean_symbol = promptline#symbols#get().clean_symbol
  let has_untracked_files_symbol = promptline#symbols#get().added_has_untracked_files_symbol
  let ahead_symbol = promptline#symbols#get().ahead_symbol
  let behind_symbol = promptline#symbols#get().behind_symbol
